...
class Simple3DCNN(nn.Module):
    def __init__(self, num_classes=3):
        ...
        self.features = nn.Sequential(
            ...
            nn.BatchNorm3d(128),
            nn.ReLU(inplace=True),
            # 自适应全局池化：将时间(seq)和空间(H,W)全部压缩为 1x1x1
...
def main():
    ...
    try:
        ...
        if os.path.exists("best_3dcnn.pth"):
